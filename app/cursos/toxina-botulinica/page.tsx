        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">
              Referência nacional em Toxina Botulínica e seu mentor neste curso exclusivo
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-sm md:text-lg text-gray-600 mb-6">
                Especialista em Medicina Estética Avançada e referência nacional em aplicação de Toxina Botulínica,
                ...
                corporal, com expertise em técnicas avançadas de rejuvenescimento facial.
              </p>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-gold flex-shrink-0" />
                  <span className="text-sm md:text-base text-gray-700">
                    Formação internacional em técnicas avançadas de toxina botulínica
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-gold flex-shrink-0" />
