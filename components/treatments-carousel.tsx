...
const treatments = [
  {
    name: "Preenchedores",
    description: "Tratamentos com ácido hialurônico para volume e definição facial.",
    image: "/preenchimento_labial_tratamento.jpg?height=300&width=400&text=Preenchedores",
    link: "/tratamentos/preenchedores",
  },
  {
    name: "Botox",
